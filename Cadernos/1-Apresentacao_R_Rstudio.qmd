...
-   Observe que o local de referência é a pasta "*Cadernos*", pois este é o caminho absoluto para a pasta onde esse aula foi produzida. Vamos voltar para a pasta "*Introducao_R*" utilizando o conceito de caminho r
